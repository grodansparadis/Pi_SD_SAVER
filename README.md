...
Against all appearances, using a "meager" Attiny85 to correct a "mighty" Raspberry PI flaw doesn't look like an overkill, but frankly it is !  Might as well do something else with it... consequently PI_SD_SAVER also provides a single push button which allows to make convenient and safe poweroffs and powerdowns of the PI.   
